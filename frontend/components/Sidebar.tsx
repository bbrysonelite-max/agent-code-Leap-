...
import { BarChart3, Users, Mail, Activity, Settings, Bot, Link, Target, Brain, Handshake, DollarSign, Shield, LogOut, FileBarChart, Lock, MessageSquare } from 'lucide-react';
...
const nurturingNavigation = [
  { name: 'AI Nurturing System', href: '/nurturing', icon: MessageSquare },
];
