...
export function Environment(name: string): BaseURL {
    return `https://${name}-agent-code-refactoring-ehii.encr.app`
}
...
/**
 * Client is an API client for the agent-code-refactoring-ehii Encore application.
 */
export class Client {
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "agent-code-refactoring-ehii-Generated-TS-Client (Encore/v1.52.2)";
        }
