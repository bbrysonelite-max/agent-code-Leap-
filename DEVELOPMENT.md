...
```bash
git remote add encore encore://agent-code-refactoring-ehii
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/agent-code-refactoring-ehii/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/agent-code-refactoring-ehii/settings/integrations/github)
